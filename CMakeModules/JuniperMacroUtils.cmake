...
MACRO(LINK_CORELIB_DEFAULT CORELIB_NAME)
    ...
    IF(OSGJUNIPER_SONAMES)
      SET_TARGET_PROPERTIES(${CORELIB_NAME} PROPERTIES VERSION ${OSGJUNIPER_VERSION} SOVERSION ${OSGJUNIPER_SOVERSION})
    ENDIF(OSGJUNIPER_SONAMES)
...
MACRO(SETUP_EXE IS_COMMANDLINE_APP)
    ...
    ELSE(${IS_COMMANDLINE_APP})
        ...
        IF(APPLE)
            ...
            SET(MACOSX_BUNDLE_SHORT_VERSION_STRING "${OSGJUNIPER_MAJOR_VERSION}.${OSGJUNIPER_MINOR_VERSION}.${OSGJUNIPER_PATCH_VERSION}")
            # Bundle version is the version the OS looks at.
            SET(MACOSX_BUNDLE_BUNDLE_VERSION "${OSGJUNIPER_MAJOR_VERSION}.${OSGJUNIPER_MINOR_VERSION}.${OSGJUNIPER__PATCH_VERSION}")
            SET(MACOSX_BUNDLE_GUI_IDENTIFIER "org.OSGJUNIPER.${TARGET_TARGETNAME}" )
